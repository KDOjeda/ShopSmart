...
import Apparel1Image from '@/components/Apparel1Image'
      ...
      <main className='flex flex-col min-h-screen mt-12'>
        <div className='px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 relative flex flex-col lg:flex-row gap-16'>
          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-6 mt-10">
            <h1 className="text-4xl font-bold mb-4 mt-7">Sports Shirts</h1>
            <h2 className='text-2xl font-bold'>₱999.00</h2>
