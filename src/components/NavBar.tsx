...
>>>>>>> 737bad9cd4c713c34de5f680b350c7bfbc470415
      <div className="h-full flex items-center justify-between md:hidden">
        {/* MOBILE */}
        <Link href="/">
          <div className="font-bold text-4xl text-center pb-4 pl-10 sm:pb-0 text-white tracking-wide text-shadow-logo">
            ShopSmart
          </div>
        </Link>
        <Menu />
      ...
      <div className="hidden md:flex items-center justify-between gap-8 h-full">
        <div className="w-1/3 xl:w-1/2 flex items-center gap-12">
          <Link href="/" className="flex items-center">
            <div className="font-bold text-4xl text-white tracking-wide text-shadow-logo">
              ShopSmart
            </div>
          </Link>
